...
#define ICM42688P_REG_INT_CFG2          0x07U
#define ICM42688P_REG_HPF_LPF_CFG       0x08U
...
#define ICM42688P_COM_CFG_BDU            (1U << 6)
#define ICM42688P_COM_CFG_ADDRESS_AUTO   (1U << 4)
#define ICM42688P_COM_CFG_SPI_4_WIRE     0x00U
...
#define ICM42688P_INT1_DRDY_ACC          0x01U
#define ICM42688P_DATA_STAT_GYR_CONF_ERR (1U << 5)
#define ICM42688P_DATA_STAT_ACC_CONF_ERR (1U << 4)
#define ICM42688P_DATA_STAT_DRDY_TEMP    (1U << 2)
#define ICM42688P_DATA_STAT_DRDY_GYRO    (1U << 1)
#define ICM42688P_DATA_STAT_DRDY_ACCEL   (1U << 0)
